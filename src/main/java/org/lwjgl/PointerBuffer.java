...
public class PointerBuffer extends CustomBuffer<PointerBuffer> implements Comparable<PointerBuffer> {
    ...
    public static PointerBuffer allocateDirect(int capacity) {
        long aloc = APIUtil.apiCheckAllocation(capacity, APIUtil.apiGetBytes(capacity, CLONG_SHIFT), 0x7FFF_FFFFL) << CLONG_SHIFT;
        
        ByteBuffer source = org.lwjgl.BufferUtils.createByteBuffer((int) aloc);
