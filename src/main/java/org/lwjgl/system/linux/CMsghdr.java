...
public class CMsghdr extends Struct implements NativeResource {
    ...
    public static CMsghdr malloc() {
        return wrap(CMsghdr.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static CMsghdr malloc(MemoryStack stack) {
        return wrap(CMsghdr.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static CMsghdr calloc(MemoryStack stack) {
        return wrap(CMsghdr.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<CMsghdr, Buffer> implements NativeResource {
         ...
         * by {@link CMsghdr#SIZEOF}, and its mark will be undefined.
         *
