...
public class IOURingBufRing extends Struct implements NativeResource {
    ...
    public static IOURingBufRing malloc() {
        return wrap(IOURingBufRing.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static IOURingBufRing calloc() {
        return wrap(IOURingBufRing.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@code IOURingBufRing} instance allocated with {@link BufferUtils}. */
    public static IOURingBufRing create() {
        ByteBuffer container = BufferUtils.createByteBuffer(SIZEOF);
        return wrap(IOURingBufRing.class, memAddress(container), container);
    }
    ...
    public static IOURingBufRing create(long address) {
        return wrap(IOURingBufRing.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static IOURingBufRing createSafe(long address) {
        return address == NULL ? null : wrap(IOURingBufRing.class, address);
    }
    ...
    public static IOURingBufRing malloc(MemoryStack stack) {
        return wrap(IOURingBufRing.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static IOURingBufRing calloc(MemoryStack stack) {
        return wrap(IOURingBufRing.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<IOURingBufRing, Buffer> implements NativeResource {
         ...
         * by {@link IOURingBufRing#SIZEOF}, and its mark will be undefined.
         *
