...
public class IOURingSyncCancelReg extends Struct implements NativeResource {
    ...
    public static IOURingSyncCancelReg malloc() {
        return wrap(IOURingSyncCancelReg.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static IOURingSyncCancelReg calloc() {
        return wrap(IOURingSyncCancelReg.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static IOURingSyncCancelReg create() {
        ...
        return wrap(IOURingSyncCancelReg.class, memAddress(container), container);
    }
    ...
    public static IOURingSyncCancelReg create(long address) {
        return wrap(IOURingSyncCancelReg.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static IOURingSyncCancelReg createSafe(long address) {
        return address == NULL ? null : wrap(IOURingSyncCancelReg.class, address);
    }
    ...
    public static IOURingSyncCancelReg malloc(MemoryStack stack) {
        return wrap(IOURingSyncCancelReg.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static IOURingSyncCancelReg calloc(MemoryStack stack) {
        return wrap(IOURingSyncCancelReg.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<IOURingSyncCancelReg, Buffer> implements NativeResource {
         ...
         * by {@link IOURingSyncCancelReg#SIZEOF}, and its mark will be undefined.
         *
