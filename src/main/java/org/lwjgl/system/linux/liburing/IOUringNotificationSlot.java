...
public class IOUringNotificationSlot extends Struct implements NativeResource {
    ...
    public static IOUringNotificationSlot malloc() {
        return wrap(IOUringNotificationSlot.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static IOUringNotificationSlot calloc() {
        return wrap(IOUringNotificationSlot.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static IOUringNotificationSlot create() {
        ...
        return wrap(IOUringNotificationSlot.class, memAddress(container), container);
    }
    ...
    public static IOUringNotificationSlot create(long address) {
        return wrap(IOUringNotificationSlot.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static IOUringNotificationSlot createSafe(long address) {
        return address == NULL ? null : wrap(IOUringNotificationSlot.class, address);
    }
    ...
    public static IOUringNotificationSlot malloc(MemoryStack stack) {
        return wrap(IOUringNotificationSlot.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static IOUringNotificationSlot calloc(MemoryStack stack) {
        return wrap(IOUringNotificationSlot.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<IOUringNotificationSlot, Buffer> implements NativeResource {
         ...
         * by {@link IOUringNotificationSlot#SIZEOF}, and its mark will be undefined.
         *
        ...
        /** Sets the specified value to the {@code tag} field. */
        public Buffer tag(@NativeType("__u64") long value) { IOUringNotificationSlot.ntag(address(), value); return this; }
        /** Copies the specified {@link LongBuffer} to the {@code resv} field. */
        public Buffer resv(@NativeType("__u64[3]") LongBuffer value) { IOUringNotificationSlot.nresv(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code resv} field. */
        public Buffer resv(int index, @NativeType("__u64") long value) { IOUringNotificationSlot.nresv(address(), index, value); return this; }
