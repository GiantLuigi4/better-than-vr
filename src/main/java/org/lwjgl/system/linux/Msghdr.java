...
public class Msghdr extends Struct implements NativeResource {
    ...
    public static Msghdr malloc() {
        return wrap(Msghdr.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static Msghdr malloc(MemoryStack stack) {
        return wrap(Msghdr.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static Msghdr calloc(MemoryStack stack) {
        return wrap(Msghdr.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<Msghdr, Buffer> implements NativeResource {
         ...
         * by {@link Msghdr#SIZEOF}, and its mark will be undefined.
         *
