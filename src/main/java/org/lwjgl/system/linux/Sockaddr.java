...
public class Sockaddr extends Struct implements NativeResource {
    ...
    public static Sockaddr malloc() {
        return wrap(Sockaddr.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static Sockaddr malloc(MemoryStack stack) {
        return wrap(Sockaddr.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static Sockaddr calloc(MemoryStack stack) {
        return wrap(Sockaddr.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends StructBuffer<Sockaddr, Buffer> implements NativeResource {
         ...
         * by {@link Sockaddr#SIZEOF}, and its mark will be undefined.
         *
